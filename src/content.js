...
// Common Arabic + Gulf + football words a healthy caption is built from.
// Used only to *score* captions (unknown tokens get a small penalty when
// choosing between two draws) — never as a hard rejection.
const ARABIC_WORDS = new Set([
  // particles & pronouns
  'في', 'من', 'على', 'إلى', 'الى', 'عن', 'مع', 'بعد', 'قبل', 'بدون', 'عند',
  'عندي', 'عندك', 'عنده', 'عندنا', 'ثم', 'أو', 'او', 'إذا', 'اذا', 'لكن',
  'لأن', 'بأن', 'أن', 'إن', 'انا', 'نحن', 'انتم', 'انت', 'هو', 'هي', 'هم',
  'هن', 'هذا', 'هذه', 'ذلك', 'تلك', 'هنا', 'هناك', 'كيف', 'شلون', 'وش',
  'شنو', 'ليش', 'وين', 'متى', 'لماذا', 'ليس', 'ليست', 'كان', 'كانت', 'يكون',
  'تكون', 'سوف', 'لن', 'لا', 'نعم', 'طيب', 'تمام', 'زين', 'والله', 'مرة',
  'مره', 'أخير', 'اخير', 'جديد', 'جديده', 'جاية', 'جاي', 'حتى', 'بس',
  'قبل', 'بعدين', 'مو', 'مب', 'توه', 'تو', 'يقول', 'قال', 'أقول', 'اقول',
  'أشوف', 'اشوف', 'تشوفون', 'تشوف', 'شفت', 'أعتقد', 'اعتقد', 'توقعت',
  'اتوقع', 'أتوقع', 'سبحان', 'الحمدلله', 'انشالله', 'إن شاء الله',
  // football & everyday nouns
  'مباراة', 'مباراتين', 'المباراة', 'فريق', 'فريقين', 'نادي', 'ناديين',
  'لاعب', 'لاعبين', 'مدرب', 'حكم', 'حكام', 'جمهور', 'مشجع', 'مشجعين',
  'ملعب', 'أرضية', 'مدرجات', 'دوري', 'كأس', 'كاس', 'بطولة', 'لقب', 'القاب',
  'جولة', 'نهائي', 'نصف', 'ربع', 'دور', 'مجموعات', 'صدارة', 'القمة', 'القمه',
  'قاع', 'هبوط', 'ترقية', 'تأهل', 'تاهل', 'خروج', 'مغادرة', 'هدف', 'هدفين',
  'أهداف', 'هاتريك', 'ثلاثية', 'ثنائية', 'رباعية', 'خماسية', 'سوبر', 'صافرة',
  'نقاط', 'نقطة', 'جدول', 'ترتيب', 'نتيجة', 'نتائج', 'تعادل', 'فوز', 'فوزين',
  'انتصار', 'خسارة', 'هزيمة', 'انهيار', 'عودة', 'ريمونتادا', 'تأجيل', 'تاجيل',
  'مؤجل', 'إلغاء', 'طرد', 'بطاقة', 'حمراء', 'صفراء', 'ضربة', 'جزاء', 'ركلات',
  'ترجيح', 'تسديدة', 'تسديدات', 'ممررة', 'ركنية', 'مقصية', 'عرضية', 'مقصية',
  'مرمى', 'شباك', 'قائم', 'عارضة', 'خط', 'تسلل', 'دفاع', 'هجوم', 'وسط',
  'خط الوسط', 'جناح', 'ظهير', 'حارس', 'قائد', 'كابتن', 'بديل', 'تبديلات',
  'تشكيلة', 'تشكيله', 'قائمة', 'مستبعد', 'مصاب', 'مصابة', 'إصابة', 'اصابة',
  'عودة', 'جاهز', 'تألق', 'تالق', 'مستوى', 'اداء', 'أداء', 'قوة', 'سرعة',
  'دقة', 'حسم', 'مفاجأة', 'مفاجاه', 'معجزة', 'لقطة', 'لقطات', 'عرض', 'استعراض',
  'كرم', 'عبقرية', 'دهاء', 'ذكاء', 'مهارة', 'مهارات', 'براعة', 'قدرات',
  'دوري', 'بريميرليج', 'روشن', 'الليغا', 'ليجا', 'دوري أبطال', 'يوروبا',
  'كونفدرالية', 'عالمي', 'اولمبي', 'مونديال', 'يورو', 'قارات', 'بطولات',
  'موسم', 'المواسم', 'استعداد', 'معسكر', 'ودية', 'وطني', 'منتخب', 'أولمبياد',
  // hype & emotion
  'نار', 'حماس', 'رهيب', 'رهيبة', 'قوي', 'قوية', 'أسطوري', 'اسطوري', 'عالمي',
  'تاريخي', 'تاريخيه', 'مجنون', 'خيالي', 'ساحق', 'ساحقة', 'حاسم', 'حاسمة',
  'مشتعل', 'مشتعلة', 'دمر', 'سحق', 'حطم', 'كسر', 'قطع', 'ذبح', 'أحرق', 'احرق',
  'اشتعل', 'انفجر', 'انفجاري', 'زلزال', 'عاصفة', 'إعصار', 'اعصار', 'صاروخ',
  'قنبلة', 'وحش', 'وحشية', 'ملك', 'بطل', 'أبطال', 'ابطال', 'أسطورة', 'اسطورة',
  'فن', 'فنون', 'سحر', 'ساحر', 'رائع', 'رائعة', 'مذهل', 'مذهلة', 'خيالي',
  'كبير', 'كبيرة', 'ضخم', 'قادم', 'قادمة', 'مستقبل', 'المستقبل', 'الماضي',
  'الحاضر', 'الليلة', 'اليوم', 'غدا', 'باجر', 'البارحة', 'امس', 'المساء',
  'الصباح', 'الظهر', 'العصر', 'الليل', 'النهار', 'الدقيقة', 'اللحظة', 'اللحظات',
  'الثواني', 'الثانية', 'الدقائق', 'الوقت', 'الوقت', 'الوقت',
  // verbs & action
  'يلعب', 'لعب', 'لعبوا', 'يلاعب', 'يلعبون', 'تقدم', 'تقدمه', 'سجل', 'سجلت',
  'سجلوا', 'يسجل', 'سجلنا', 'أضاع', 'اضاع', 'ضيع', 'أهدر', 'اهدر', 'مرر',
  'يصنع', 'صنع', 'صنعها', 'سيطر', 'يسيطر', 'فرض', 'يفرض', 'رفع', 'رفعوا',
  'وصل', 'يوصل', 'أوصل', 'اوصل', 'حسم', 'يحسم', 'خطف', 'يخطف', 'سرق',
  'يسرق', 'نقلب', 'ينقلب', 'قلب', 'قلبها', 'أطاح', 'اطاح', 'أسقط', 'اسقط',
  'قضى', 'يقضي', 'أنهى', 'انهى', 'أنهاها', 'روح', 'يروح', 'أتى', 'اتى',
  'جاء', 'جا', 'يجي', 'ذهب', 'يرجع', 'رجع', 'عاد', 'يعود', 'بقي', 'يبقى',
  'ظل', 'استمر', 'يستمر', 'تابع', 'يتابع', 'واصل', 'يواصل', 'تصدر', 'يتصدر',
  'صعد', 'يصعد', 'هبط', 'يهبط', 'لحق', 'يلحق', 'تجاوز', 'يتجاوز', 'تفوق',
  'يفوق', 'فاز', 'يفوز', 'خسر', 'يخسر', 'ربح', 'يربح', 'انتصف', 'تقيد',
  'هدد', 'يهدد', 'اقترب', 'يقترب', 'ابتعد', 'يبتعد', 'توقع', 'يتوقع', 'اثبت',
  'يثبت', 'أثبت', 'أظهر', 'اظهر', 'يظهر', 'فاجأ', 'يفاجئ', 'فاجا', 'أذهل',
  'اذهل', 'ادهش', 'جمد', 'أسكت', 'اسكت', 'اخرس', 'أخرس', 'سكت', 'الصمت',
  'الخبر', 'التقارير', 'تقارير', 'اخبار', 'أخبار', 'أعلن', 'اعلن', 'يعلن',
  'يؤكد', 'أكد', 'اكد', 'شوهد', 'شاهد', 'يشاهد', 'يصور', 'تصوير', 'صورة',
  'صور', 'فيديو', 'لقاء', 'مؤتمر', 'تصريح', 'تصريحات', 'صحفي', 'إعلامي',
  'إعلامي', 'تغطية', 'مباشر', 'مباشرة', 'حصري', 'حصريه',
  // misc good words
  'السعودية', 'السعودي', 'السعودية', 'آسيا', 'اوروبا', 'أوروبا', 'افريقيا',
  'أمريكا', 'امريكا', 'العالم', 'الاسطورة', 'الأسطوري', 'الشعب', 'الجماهير',
  'الجمهور', 'الملعب', 'المدرب', 'اللاعب', 'الحارس', 'الهداف', 'الهدافين',
  'الترتيب', 'المركز', 'الفرق', 'الاندية', 'الأندية', 'فرق', 'منتخبات',
  'القارات', 'البطولات', 'التصفيات', 'المونديال', 'العالمية', 'الآسيوية',
  ...
  'تأثير', 'اثر', 'أثر', 'تاثير', 'يؤثر', 'يؤثرون', 'خطوط', 'خطوطه',
  'خطوطها', 'جدا', 'جداً', 'جدن', 'جدًا',
]);

// Count Arabic tokens in the body that look like invented gibberish (not in
// the common-word list, not a known club/star alias, not a digit). Translitera-
// tions of players get a mild penalty too, but choosing between two draws that
// is still the right bias.
function unknownTokenCount(body, ctx) {
  const tokens = String(body).match(/[\u0600-\u06FF]{3,}/g) || [];
  const aliases = new Set();
  for (const pair of NAMED_ENTITIES) {
    for (const a of pair) aliases.add(normText(a).replace(/^ال/, ''));
  }
  let unknown = 0;
